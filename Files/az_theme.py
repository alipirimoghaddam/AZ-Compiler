...
class AZtheme:
    ...
    ╠═╝╠═╣║║║║║║║ ║╚═╗ ║ ╚═╗
    ╩  ╩ ╩╩ ╩╩ ╩╚═╝╚═╝ ╩ ╚═╝{cls.ENDC}
    {cls.BLUE}Advanced Console Interface v1.0{cls.ENDC}
    ...
    def input(cls, prompt):
        ...
        sys.stdout.write(f"{cls.PURPLE}{cls.BOLD}[INPUT] {prompt}{cls.ENDC}")
        return input()
    ...
    @classmethod
    def downloading(cls, filename, speed="512 kbps"):
